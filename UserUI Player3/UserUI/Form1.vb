...
Public Class Form1
    ...
    Dim NIckFrefix As String = "Player 3"
    ...
    Public Sub Manananggal()
        ...
        PictureBox1.Image = Image.FromFile("D:\Documents\School Stuff\Fifth Year\2nd Sem\Final Project - Gabi ng Lagim\Pictures\.png")
    End Sub
    Public Sub Pulis()
